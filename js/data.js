...
const INITIAL_REQUESTS = [
  ...
  },
  {
    ...
    product: 'CDI',
    model: 'K92',
    processOperation: 'Automated Optical Inspection',
    shift: 'II',
    repeatedOrNew: 'New',
    resp: 'QA',
    observation: '•Optical micrometer sensor drift observed on surface eccentricity.\n•Checked calibration standard block and verified laser sensitivity tolerance.',
    quantity: '980',
    unit: 'Units',
    ...
    priority: 'Critical',
    comments: 'Perform 100% laser micrometer dimensional check on surface roughness and bore eccentricity.',
    attachments: [
      {
        id: 'att-3',
